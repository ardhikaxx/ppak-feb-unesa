    ...
    <div class="container">
        ...
        <div class="p-4 p-lg-5 rounded-4 border bg-subtle mb-5">
            <div class="row align-items-center g-4">
                <div class="col-lg-8">
                    ...
                    <p class="lead text-dark mb-3">Program Studi Pendidikan Profesi Akuntan (PPAk) FEB UNESA menyelenggarakan pendidikan profesi untuk membentuk lulusan yang menguasai kompetensi teoritis dan aplikatif di bidang akuntansi profesional.</p>
                    <p class="text-secondary small mb-0">Pendidikan profesi merupakan tahapan akademik pascasarjana, sedangkan sebutan profesi dan sertifikasi keprofesian diselenggarakan oleh organisasi profesi resmi (IAI dan IAPI) yang memiliki regulasi, kurikulum ujian, dan persyaratan tersendiri.</p>
                </div>
        ...
        <div class="p-4 p-lg-5 rounded-4 border bg-white shadow-sm mb-5">
            <div class="text-center max-w-700 mx-auto mb-4">
                ...
                <p class="small text-secondary mb-0">Proses terstruktur dari penuntasan beban studi pendidikan profesi hingga keikutsertaan dalam ujian sertifikasi profesi masing-masing lembaga.</p>
            </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="p-4 rounded-3 border bg-subtle h-100 text-center">
                        ...
                        <p class="small text-secondary mb-0">Menempuh pembelajaran komprehensif 11 mata kuliah terpadu dan paket magang industri sesuai kurikulum SINDIG UNESA.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="p-4 rounded-3 border bg-subtle h-100 text-center">
                        ...
                        <p class="small text-secondary mb-0">Lulus dari program studi, memperoleh ijazah profesi, serta menyelesaikan seluruh persyaratan akademik dan praktika.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="p-4 rounded-3 border bg-subtle h-100 text-center">
                        ...
                        <p class="small text-secondary mb-0">Mengikuti ujian sertifikasi profesi (CA oleh IAI atau CPA of Indonesia oleh IAPI) serta registrasi sesuai persyaratan masing-masing lembaga.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6">
                <div class="p-4 p-lg-5 rounded-4 border bg-white h-100 shadow-sm d-flex flex-column">
                    ...
                    <p class="small text-secondary mb-3" style="line-height: 1.65;">Chartered Accountant (CA) Indonesia merupakan sebutan profesi akuntan yang ditetapkan oleh <strong>Ikatan Akuntan Indonesia (IAI)</strong> untuk akuntan profesional yang memenuhi standar kompetensi internasional.</p>
            ...
            <div class="col-lg-6">
                <div class="p-4 p-lg-5 rounded-4 border bg-white h-100 shadow-sm d-flex flex-column">
                    ...
                    <p class="small text-secondary mb-3" style="line-height: 1.65;">Certified Public Accountant (CPA) of Indonesia merupakan sertifikasi kompetensi yang diselenggarakan oleh <strong>Institut Akuntan Publik Indonesia (IAPI)</strong> melalui CPA of Indonesia Exam.</p>
                    <div class="p-3 bg-subtle rounded-3 border mb-3">
                        <h4 class="fs-6 fw-bold text-navy mb-2">Ketentuan Ujian & Sertifikasi:</h4>
