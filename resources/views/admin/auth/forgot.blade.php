        ...
        <div class="login-card mx-auto">
            ...
            <div class="card shadow">
                <div class="card-body p-4">
                    ...
                    <h2 class="h5 fw-bold mb-1">Lupa Password</h2>
                    <p class="text-muted small mb-4">Masukkan email akun admin Anda untuk verifikasi. Jika email terdaftar, Anda akan diarahkan ke halaman ubah password baru.</p>
                    ...
                    <form method="POST" action="{{ route('admin.password.email') }}" novalidate>
                        ...
                        <button type="submit" class="btn btn-primary w-100 fw-semibold">
                            <i class="fa-solid fa-envelope-circle-check me-1"></i>Verifikasi Email
                        </button>
                    </form>
