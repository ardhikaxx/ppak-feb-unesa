            ...
            <div class="col-lg-6">
                <div class="card-ppak-flat h-100 bg-subtle">
                    ...
                    <p class="small text-secondary mb-3">
                        Seluruh transaksi pembayaran biaya pendaftaran maupun UKT semester menggunakan kode <strong>Virtual Account (VA)</strong> resmi yang diterbitkan oleh sistem PMB/SIAKAD UNESA:
                    </p>
                ...
                <div class="card-ppak-flat h-100 bg-subtle">
                    ...
                    <ul class="list-unstyled small text-secondary mb-0">
                        ...
                        <li class="d-flex align-items-center gap-2">
                            ...
                            <span>Lokasi: Gedung G6 FEB Kampus Ketintang Surabaya</span>
                        </li>
                    </ul>
                </div>
            </div>
