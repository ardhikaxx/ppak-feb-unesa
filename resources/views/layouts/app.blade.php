...
<head>
    ...
    <meta property="og:image:secure_url" content="@yield('og_image', asset(ltrim(config('ppak.seo.default_image'), '/')))">
    <meta property="og:image:type" content="image/jpeg">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:image:alt" content="@yield('og_title', View::hasSection('title') ? trim($__env->yieldContent('title')) : config('ppak.seo.default_title'))">
