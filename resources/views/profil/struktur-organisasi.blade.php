...
<section class="section-py bg-white">
    <div class="container">
        <div class="text-center max-w-700 mx-auto mb-5">
            ...
            <p class="text-secondary">Hubungan kelembagaan Program Studi Pendidikan Profesi Akuntan dalam struktur tata kelola Universitas Negeri Surabaya dan Fakultas Ekonomika dan Bisnis.</p>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card-ppak-flat h-100 bg-white shadow-sm">
                    ...
                    <p class="small text-secondary mb-0">Tata kelola fakultas dipimpin oleh Dekan bersama para Wakil Dekan bidang akademik, keuangan & sumber daya, serta kemahasiswaan dan alumni yang menetapkan kebijakan strategis bagi seluruh program studi di FEB UNESA.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card-ppak-flat h-100 bg-white shadow-sm">
                    ...
                    <p class="small text-secondary mb-0">Penyelenggaraan operasional kurikulum, penugasan dosen pengampu, evaluasi proses pembelajaran, dan layanan mahasiswa dikoordinasikan secara langsung oleh Koordinator Program Studi.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card-ppak-flat h-100 bg-white shadow-sm">
                    ...
                    <p class="small text-secondary mb-0">Didukung oleh fasilitas Laboratorium Akuntansi Komputer FEB UNESA, sarana perpustakaan fakultas, serta unit tata usaha FEB untuk administrasi persuratan dan bantuan teknis perkuliahan.</p>
                </div>
            </div>
        </div>
    </div>
