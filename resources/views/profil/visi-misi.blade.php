            ...
            <div class="d-flex align-items-start gap-4">
                ...
                <div>
                    ...
                    <div class="p-3 bg-white rounded-3 border">
                        ...
                        <div class="small text-secondary">Program studi berkomitmen menyajikan informasi faktual yang bersumber langsung dari dokumen resmi kelembagaan PPAk FEB UNESA dan tidak menduplikasi visi-misi program studi sarjana maupun magister lainnya.</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 mb-5">
            <div class="col-lg-4">
                <div class="card-ppak-flat h-100 bg-white shadow-sm">
                    ...
                    <p class="small text-secondary mb-0">Penyelenggaraan akademik berpedoman pada kurikulum 11 mata kuliah terpadu dan paket magang industri yang telah tercatat resmi pada sistem SINDIG UNESA.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card-ppak-flat h-100 bg-white shadow-sm">
                    ...
                    <p class="small text-secondary mb-0">Telah memperoleh status akreditasi <strong>Baik</strong> berdasarkan Keputusan LAMEMBA No. 611/DE/A.5/AR.11/II/2025 dengan masa berlaku 2025–2027.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card-ppak-flat h-100 bg-white shadow-sm">
                    ...
                    <p class="small text-secondary mb-0">Pembelajaran diarahkan pada pencapaian kompetensi standar keprofesian akuntan (Chartered Accountant & Certified Public Accountant of Indonesia).</p>
                </div>
            </div>
        </div>
