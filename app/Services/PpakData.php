...
class PpakData
{
    ...
    public static function getUnduhan(): array
    {
        return [
            ...
            [
                'id' => 2,
                'judul' => 'Sertifikat & SK Akreditasi LAMEMBA Pendidikan Profesi Akuntan',
                'title' => 'Sertifikat & SK Akreditasi LAMEMBA Pendidikan Profesi Akuntan',
            ...
            [
                'id' => 3,
                'judul' => 'Brosur & Informasi Admisi PMB Program Profesi UNESA',
                'title' => 'Brosur & Informasi Admisi PMB Program Profesi UNESA',
                'slug' => 'brosur-admisi-profesi-unesa',
                'filename' => 'brosur-admisi-profesi-unesa.pdf',
                'kategori' => 'Admisi & Brosur',
                'nomor_sk' => 'Portal PMB UNESA',
                'tanggal' => '2026',
                'tahun' => '2026',
                'ukuran' => '1.2 MB',
                'size' => '1.2 MB',
                'format' => 'PDF',
                'instansi' => 'Admisi UNESA',
                'url' => 'https://admisi.unesa.ac.id',
                'source' => 'Admisi UNESA',
            ],
        ];
    ...
    public static function getGaleri(): array
    {
        return [
            ...
            [
                'id' => 3,
                'title' => 'Ruang Smart Classroom & Diskusi Interaktif',
                'category' => 'Ruang Kuliah',
                'date' => '2026',
                'image' => '/images/default-img.png',
                'description' => 'Ruang perkuliahan interaktif yang mendukung kegiatan pembelajaran profesi akuntan.',
                'source' => 'Dokumentasi Resmi FEB UNESA',
            ],
        ];
    }
