...
class PpakData
{
    ...
    public static function getDosen(): array
    {
        return [
            [
                ...
                'image' => '/images/dosen/dosen-rediyanto-putra.jpg',
            ...
            [
                ...
                'image' => '/images/dosen/dosen-bayu-rama-laksono.jpg',
            ...
            [
                ...
                'image' => '/images/dosen/dosen-loggar-bhilawa.jpg',
            ...
            [
                ...
                'image' => '/images/dosen/dosen-pujiono.jpg',
    ...
    public static function getBerita(array $onlyColumns = []): array
    {
        $all = [
            [
                'id' => 1,
                'slug' => 'sosialisasi-kurikulum-pendidikan-profesi-akuntan-feb-unesa',
                'title' => 'Sosialisasi Kurikulum dan Capaian Pembelajaran Pendidikan Profesi Akuntan FEB UNESA',
                ...
                'image' => '/images/berita/berita-kurikulum-ppak.jpg',
            ...
            [
                ...
                'image' => '/images/berita/berita-kalender-akademik.png',
            ...
            [
                ...
                'read_time' => '3 Menit Baca',
                'author' => 'Admisi UNESA',
                'image' => '/images/berita/berita-admisi-pmb.jpg',
            ...
            [
                ...
                'read_time' => '3 Menit Baca',
                'author' => 'Humas FEB UNESA',
                'image' => '/images/berita/berita-transparansi-akuntansi.jpg',
            ...
            [
                ...
                'image' => '/images/berita/berita-profesi-akuntan.jpg',
    ...
    public static function getGaleri(): array
    {
        return [
            [
                ...
                'date' => '2026',
                'image' => '/images/galeri/galeri-gedung-feb-unesa.png',
            ...
            [
                ...
                'date' => '2026',
                'image' => '/images/galeri/galeri-laboratorium-akuntansi.png',
            ...
            [
                ...
                'date' => '2026',
                'image' => '/images/galeri/galeri-auditorium-g6-feb.png',
            ...
            [
                ...
                'date' => '2026',
                'image' => '/images/galeri/galeri-diskusi-interaktif-mahasiswa.png',
